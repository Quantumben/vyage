    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav align-items-center ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" href="#home">Homemyy</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#feature">Features Timothy</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
            <div class="col-sm-4">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary" target="_blank"><i class="fas fa-user me-2"></i>Get started</a>
                </div>
            </div>
            <div class="col-sm-6">
                <img
        ...
        <div class="row align-items-center justify-content-start">
            ...
            <div class="col-sm-4">
                ...
                <div class="my-4 wow animate__fadeInRight" data-wow-delay="0.8s">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary" target="_blank">Login</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/quantumben/code/vyage/resources/views/layouts/landing.blade.php ENDPATH**/ ?>